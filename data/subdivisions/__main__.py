...
def main():
    ...
    countries: dict[str, CountryDTO] = load_countries()
    ...
    iso_subs: dict[int, SubdivisionDTO] = load_iso_subs(countries)
    ...
    unmatched_iso_subs: list[SubdivisionDTO] = try_merge(iso_subs, sub_map)
