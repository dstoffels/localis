...
def main():
    ...
    countries: dict[str, CountryData] = load_countries()
    ...
    iso_subs: dict[int, SubdivisionData] = load_iso_subs(countries)
    ...
    unmatched_iso_subs: list[SubdivisionData] = try_merge(iso_subs, sub_map)
